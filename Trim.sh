...
if [[ "$RUN_AR" -eq "1" ]]; then
  ...
  #
  ./AdapterRemoval --file1 SRR518659_1.fastq --file2 SRR518659_2.fastq --basename PE_SRR518659 --trimns --trimqualities --minlength 20 --gzip
  #
  ...
  #
  ./AdapterRemoval --file1 SRR518706_1.fastq --file2 SRR518706_2.fastq --basename PE_SRR518706 --trimns --trimqualities --minlength 20 --gzip
  #
